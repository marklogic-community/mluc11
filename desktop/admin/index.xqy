...
<html> 
    <head> 
        ...
        <script src="/admin/js/SessionList.js" type="text/javascript"><!-- --></script>
        <script src="/admin/js/SpeakerSelectionList.js" type="text/javascript"><!-- --></script>
        <script src="/admin/js/SessionDetails.js" type="text/javascript"><!-- --></script>
        <script src="/admin/js/SpeakerList.js" type="text/javascript"><!-- --></script>
        <script src="/admin/js/SpeakerDetails.js" type="text/javascript"><!-- --></script>
