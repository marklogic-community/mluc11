                ...
                '<div class="tweets">',
                    '<tpl for=".">',
                        '<div class="tweet">',
                            ...
                            '<div class="text"><span class="username"><a href="http://twitter.com/{[values.get("from_user")]}" target="_blank">{[values.get("from_user")]}</a></span><br>',
                            '{[this.linkifyText(values.get("text"))]}<br>',
                            '<span class="date">{[values.get("date_formatted")]}</span></div>',
                        '</div>',
                    '</tpl>',
                '</div>',
                {
