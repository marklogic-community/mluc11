        ...
        '<div class="tweets">',
            '<tpl for=".">',
                '<div class="tweet">',
                    ...
                    '<div class="text"><span class="username"><a href="http://twitter.com/{from_user}" target="_blank">{from_user}</a></span> - ',
                    '<span class="date">{created_at_date:date("D M j, g:ia")}</span><br>{[this.linkifyText(values.text)]}</div>',
                '</div>',
            '</tpl>',
        '</div>',
        {
